...
I'm currently pursuing an M.S. in Computer Science at the University of Massachusetts Amherst, graduating in May 2027 with a 4.0 GPA. My work has largely focused on machine learning, data systems, and backend engineering, with two publications in medical imaging AI, including work published in Frontiers in Radiology and at ICAECT 2024. Outside of research, I enjoy building systems that move beyond prototypes into reliable, production-style applications — I've worked on projects involving RAG pipelines, agentic research assistants, vector search infrastructure, anomaly detection systems, and scalable ML workflows using tools like FastAPI, PostgreSQL, Redis, and Docker. What interests me most is the engineering challenge of turning complex ML ideas into systems that are fast, maintainable, and useful in real-world environments. I'm also AWS Certified and enjoy learning deeply by building, experimenting, and solving problems end to end.
